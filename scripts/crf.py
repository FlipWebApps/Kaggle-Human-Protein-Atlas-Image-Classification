...
# Conditional Random Fields on the predicted masks
...
test_path = '../data/raw/test/images/'
...
if __name__ == '__main__':
    ...
    new_filename = name + "_crf" + ext
    convert_crf(df).to_csv(new_filename, index=False)
